...
public class NotificationGenerator {
    public static final String NOTIFY_PREVIOUS = "com.example.myapplication.previous";
    public static final String NOTIFY_DELETE = "com.example.myapplication.delete";
    public static final String NOTIFY_PAUSE = "com.example.myapplication.pause";
    public static final String NOTIFY_PLAY = "com.example.myapplication.play";
    public static final String NOTIFY_NEXT = "com.example.myapplication.next";
